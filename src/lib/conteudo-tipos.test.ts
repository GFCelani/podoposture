...
describe("apoio para renderizar", () => {
  it("o subtitulo do padrao sai com o nome em destaque e o resto corrido", () => {
  ...
  it("dois trechos, um deles atravessando a quebra de linha", () => {
    // A composicao anterior do hero, que exercitava os dois destaques.
    const linhas = [
    ...
    expect(segmentosDoSubtitulo(linhas, ["Dra. Claudia Meirelles", "30 anos de experiência clínica"])).toEqual([
      { texto: "Dra. Claudia Meirelles", destaque: 0 },
