...
/**
 * Os quatro destinos sociais.
 * LinkedIn e Pinterest chegaram malformados do site antigo (dominio duplicado e
 * "https" truncado para "ttps") e por isso nao abriam. Preservar um link
 * quebrado nao preserva destino nenhum: as URLs corrigidas vivem em lib/site.
 */
